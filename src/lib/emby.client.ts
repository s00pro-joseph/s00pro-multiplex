...
export class EmbyClient {
  ...
  private static readonly DEFAULT_AUTHORIZATION_HEADER =
    'MediaBrowser Client="s00pro-multiplex", Device="Web", DeviceId="s00pro-multiplex-web", Version="1.0.0"';
  ...
  constructor(config: EmbyConfig) {
    ...
    this.embyAuthorizationHeader =
      config.embyAuthorizationHeader?.trim() ||
      EmbyClient.DEFAULT_AUTHORIZATION_HEADER;
