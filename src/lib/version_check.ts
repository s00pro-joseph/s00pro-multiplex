...
const VERSION_CHECK_URLS = [
  'https://raw.githubusercontent.com/s00pro-joseph/s00pro-multiplex/refs/heads/main/VERSION.txt',
];
...
const SESSION_STORAGE_KEY = 's00pro-multiplex_version_check_cache';
